...
The rest of the chapter explored how this sampling primitive can be used in matrix approximation algorithms that previously assumed access to squared row or column norm distributions. In particular, we considered Frobenius norm approximation, additive-error eigenvalue approximation, additive-error low-rank approximation, and robust low-rank approximation.
